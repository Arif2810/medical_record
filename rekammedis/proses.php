...
if(isset($_POST['add'])){
	...
	mysqli_query($con, "INSERT INTO tb_rekammedis VALUES('$uuid', '$tgl', '$pasien', '$keluhan', '$dokter', '$diagnosa', '$rujukan', '$paramedic')") or die(mysqli_error($con));
	...
	mysqli_query($con, "UPDATE tb_rekammedis SET tgl_periksa = '$tgl', id_pasien = '$pasien', keluhan = '$keluhan', id_dokter = '$dokter', diagnosa = '$diagnosa', rujukan = '$rujukan', paramedic = '$paramedic' WHERE id_rm = '$id'") or die(mysqli_error($con));
